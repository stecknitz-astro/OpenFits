...
const
  ...
  cNAXIS1   = 'NAXIS1';
  cNAXIS2   = 'NAXIS2';
  cNAXIS3   = 'NAXIS3'; //!! added for RWB extension/fs 23.02.2020
...
type
  ...
  THduCore2d = record
    Simple: Boolean;
    BitPix: TBitPix;
    NAxis1, NAxis2, NAxis3: Word; //!! NAxis3 added for RWB extension/fs 23.02.2020
    BScale: Double;
    BZero: Double;
  end;
...
type
  ...
  TDataHandle = record
    ...
    NAxis1: Word;
    NAxis2: Word;
    NAxis3: Word; // !! Added for RGB extenion/fs
    BScale: Double;
    BZero: Double;
  end;
